...
///     is not auto-injected). <see cref="MemberName" /> is the property to assign, and
...
///     the instance is constructed and cached, so it contributes no <em>cycle</em> edge, which lets
