		...
		bool importServices = false)
	{
		...
		IMethodSymbol? resolvable = constructors
			.Where(c => c.Parameters.All(p =>
			{
				...
				return parameter.Kind is DependencyKind.Arg or DependencyKind.Enumerable or DependencyKind.AsyncEnumerable or DependencyKind.AwaitedEnumerable or DependencyKind.KeyedCollection or DependencyKind.AwaitedKeyedCollection or DependencyKind.External
