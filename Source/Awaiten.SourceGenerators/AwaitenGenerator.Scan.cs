...
partial class AwaitenGenerator
{
		...
		VarianceState variance)
	{
		...
		foreach (IParameterSymbol parameter in constructor.Parameters)
		{
			...
			bool satisfiable =
				model.Kind is DependencyKind.Arg or DependencyKind.Enumerable or DependencyKind.AsyncEnumerable or DependencyKind.AwaitedEnumerable or DependencyKind.KeyedCollection or DependencyKind.AwaitedKeyedCollection or DependencyKind.External
		...
		HashSet<string> constraintRejected)
	{
		...
		if (member.Kind is not (DependencyKind.Enumerable or DependencyKind.AsyncEnumerable or DependencyKind.KeyedCollection or DependencyKind.AwaitedKeyedCollection)
