...
---------|----------|----------|----------------------------------------------------
 ...
 AWT198  | Awaiten   | Error    | A generic lifecycle hook on an open-generic [Scan] marker matched a type that closes the marker more than once, so the hook's type argument is ambiguous
