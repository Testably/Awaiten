...
/// <summary>
///     An immutable, equatable array. This is equivalent to <see cref="Array" /> but with value
///     equality support, so models flowing through the incremental pipeline cache correctly.
/// </summary>
/// <remarks>
///     <see
	...
	where T : IEquatable<T>
{
	...
	/// <summary>
	///     Returns the underlying wrapped array, or an empty array when default-constructed.
	/// </summary>
