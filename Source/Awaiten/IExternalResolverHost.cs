...
public interface IExternalResolverHost
{
	...
	///     dependencies through. Defaults to <see langword="null" /> - a child scope then falls back to the
	///     root's resolver, and resolving an external dependency with neither set throws.
	/// </summary>
