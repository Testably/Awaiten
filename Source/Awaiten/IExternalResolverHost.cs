...
/// <summary>
///     A scope that routes its <c>[ImportService&lt;T&gt;]</c> / <c>[ImportServices]</c> dependencies through an
...
{
	/// <summary>
	///     The external resolver this scope routes its <c>[ImportService&lt;T&gt;]</c> / <c>[ImportServices]</c>
