...
[![Build](https://github.com/vbreuss/Awaiten/actions/workflows/build.yml/badge.svg)](https://github.com/vbreuss/Awaiten/actions/workflows/build.yml)
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=Awaiten_Awaiten&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=Awaiten_Awaiten)
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=Awaiten_Awaiten&metric=coverage)](https://sonarcloud.io/summary/overall?id=Awaiten_Awaiten)
[![Mutation testing badge](https://img.shields.io/endpoint?style=flat&url=https%3A%2F%2Fbadge-api.stryker-mutator.io%2Fgithub.com%2Fvbreuss%2FAwaiten%2Fmain)](https://dashboard.stryker-mutator.io/reports/github.com/vbreuss/Awaiten/main)

**Compile-time, attribute-based dependency injection for .NET — with first-class async initialization.**
